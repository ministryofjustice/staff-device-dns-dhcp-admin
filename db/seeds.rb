...
def exclusion_start_address(range)
  range_array = range.to_s.split(".")
  last_char = range_array.last.to_i + rand(30..40)
  range_array[0].to_s + "." + range_array[1].to_s + "." + range_array[2].to_s + "." + last_char.to_s
end

def exclusion_end_address(range)
  range_array = range.to_s.split(".")
  last_char = range_array.last.to_i + rand(80..90)
  range_array[0].to_s + "." + range_array[1].to_s + "." + range_array[2].to_s + "." + last_char.to_s
end
...
def main
  150.times do |count|
    ...
    5.times do |subnet_count|
      ...
      subnet.exclusions.create!(start_address: exclusion_start_address(range), end_address: exclusion_end_address(range))
      p end_address(range)
    end
  end
end
