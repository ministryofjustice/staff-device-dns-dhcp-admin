class ClientClass < ApplicationRecord
  ...
  validates :client_id, format: {with: CLIENT_ID_REGEX, message: "may only contain letters, numbers, underscores and dashes"}, presence: true, uniqueness: {case_sensitive: false}
